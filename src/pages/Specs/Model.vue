    ...
    <el-form :model="form" :rules="rules" ref="formRef">
      ...
      <el-form-item label="规格属性" label-width="80px">
        <div class="box" v-for="(item,index) in list" :key="index">
          ...
          <el-button type="success" class="btn" v-if="index == 0" @click="increase(index)">添加</el-button>
          <el-button type="danger" class="btn" v-else @click="decrease(index)">删除</el-button>
        </div>
      </el-form-item>
