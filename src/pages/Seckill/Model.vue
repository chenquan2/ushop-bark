    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="用户管理" name="first">
        <el-form :model="form" :rules="rules" ref="formRef">
          ...
          <el-form-item label="商品名称" label-width="80px" prop="seckillname">
            <el-input v-model="form.seckillname" autocomplete="off"></el-input>
          </el-form-item>
